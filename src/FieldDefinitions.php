    ...
    public static function all(): array
    {
        return [
            'text' => [
                ...
                'properties' => ['name', 'label', 'placeholder', 'required', 'className', 'controlClass'],
                'defaults' => [
                    'name' => 'text_field',
                    'label' => 'Text Field',
                    'placeholder' => '',
            ...
            'select' => [
                ...
                'properties' => ['name', 'label', 'required', 'options', 'className', 'controlClass'],
                'defaults' => [
                    'name' => 'select_field',
                    'label' => 'Select Option',
                    'required' => false,
            ...
            'checkbox' => [
                ...
                'properties' => ['name', 'label', 'required', 'className', 'controlClass'],
                'defaults' => [
                    'name' => 'checkbox_field',
                    'label' => 'I agree',
                    'required' => false,
